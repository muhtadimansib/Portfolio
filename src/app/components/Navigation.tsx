...
//         : `${darkMode ? "bg-gray-900/60" : "bg-white/60"} backdrop-blur-md`}`}
//     >
...
//                   } text-lg md:text-xl transition-colors duration-200 font-medium`}
//               >
//                 {item.label}
//               </motion.a>
//             ))}
...
//                 key={item.label}
//                 href={item.href}
//                 className={`block py-2 ${darkMode ? "text-gray-300 hover:text-blue-400" : "text-gray-900 hover:text-blue-600"
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled
          ? `${darkMode ? "bg-gray-900/80" : "bg-white/80"} backdrop-blur-md shadow-lg`
          : `${darkMode ? "bg-gray-900/60" : "bg-white/60"} backdrop-blur-md`
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {navItems.map((item) => (
              <a
                ...
                className={`block py-2 ${
                  darkMode ? "text-gray-300 hover:text-blue-400" : "text-gray-900 hover:text-blue-600"
                } transition-colors duration-200`}
                onClick={() => setIsMobileMenuOpen(false)}
              >
                {item.label}
